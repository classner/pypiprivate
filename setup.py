...
extras_require = {"azure": ["azure-storage-blob==12.2.0"]}
...
setup(
    ...
    install_requires=["setuptools>=36.0.0", "Jinja2==3.1.2", "boto3==1.26.74"],
    extras_require=extras_require,
    packages=["pypiprivate"],
    entry_points={"console_scripts": ["pypi-private = pypiprivate.cli:main"]},
    classifiers=[
        "Environment :: Console",
